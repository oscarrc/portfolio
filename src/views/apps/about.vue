<template>
  <v-card tile class="app">
    ...
    />
    <v-container class="app-wrapper pa-0 pb-10">
      <v-row class="justify-space-around app-row ma-0">
                  ...
                  <v-timeline dense>
                    ...
                    <v-timeline-item fill-dot icon="mdi-server">
                      <div class="py-4">
                        ...
                        <ul>
                          ...
                          <li>
                            Design, develoment and deployment of microsites on
                            our server
                          </li>
                          <li>
                    ...
                    <v-timeline-item fill-dot icon="mdi-router-network">
                      <div class="py-4">
                        ...
                        <ul>
                          <li>
                            Installation and monitoring of enterprise-level
                            local area networks
                          </li>
                        </ul>
                      </div>
