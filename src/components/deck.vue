<template>
  <v-footer id="deck" fixed rounded padless elevation="2" color="transparent">
    <v-card width="100%" color="rgba(255, 255, 255, 0.2)" class="text-center">
      ...
      <v-card-text class="white--text">
        ...
        <v-icon small dark>mdi-heart</v-icon>,
        <v-icon small dark>mdi-vuejs</v-icon>,
        <v-icon small dark>mdi-vuetify</v-icon>, and
        <v-icon small dark>mdi-firebase</v-icon>
        by Oscar R.C.
      </v-card-text>
    </v-card>
  </v-footer>
